...
Accepted on 2026-09-08 as a compatible relaxation and normative clarification.
The implementation in MCP Description 0.8.0 RC.4 removes protocol-revision
gates from root Info metadata while preserving revision checks on scoped MCP
declarations and values. See [Issue #60](https://github.com/mcpdesc/mcpdesc-specification/issues/60),
[Proposal PR #61](https://github.com/mcpdesc/mcpdesc-specification/pull/61), and
implementation commit
[`844f7d7`](https://github.com/mcpdesc/mcpdesc-specification/commit/844f7d7).