...
| [`validate-0.8.mjs`](validate-0.8.mjs) | Current 0.8.0 working-tree facade used by repository and Effective Protocol View tooling. It extends the shared Draft 1 semantic base without modifying immutable validator snapshots. | See the package README for the cumulative public Draft 1 and Draft 2 API. |
